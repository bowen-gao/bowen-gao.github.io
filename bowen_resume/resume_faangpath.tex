...
\\
Ph.D. in Computer Science and Technology \hfill {\em Aug 2024 - Dec 2027 (Expected)} 
...
\\
Master of Electrical Engineering \hfill {\em Oct 2019 - Jun 2021}
 \begin{itemize}[leftmargin=1.5em, itemsep=2pt, parsep=0pt, topsep=3pt]
     \item GPA: 4.2 / 4.3
     \item Advised by Professor Yaser Abu-Mostafa and Professor Yisong Yue
 \end{itemize}

{\bf University of Toronto} \hfill Toronto, Canada
\\
Bachelor of Computer Science \hfill {\em Sep 2014 - Jun 2019}
 \begin{itemize}[leftmargin=1.5em, itemsep=2pt, parsep=0pt, topsep=3pt]
     \item GPA: 3.85 / 4.0
...
My research focuses on leveraging artificial intelligence for drug discovery (AIDD), with a particular emphasis on developing and applying deep learning models for the representation and generation of small molecules and proteins. I aim to build \textbf{data-centric and knowledge-centric} methods to address the data scarcity problem in the AIDD domain, and build \textbf{agent systems} that can effectively accelerate the drug discovery process.
...
\textbf{Institute for AI Industry Research, Tsinghua University (AIR)} \hfill {\em Sep 2022 - Aug 2024}
\\
Full Time Research Engineer

\vspace{0.5em}

\textbf{Applied Machine Learning (AML) at ByteDance} \hfill {\em Jul 2021 - Sep 2022}
\\
Full Time Machine Learning Engineer

\vspace{0.5em}

\textbf{Uber ATG} \hfill {\em Jun 2020 - Sep 2020}
\\
...
\begin{enumerate}[leftmargin=2em, itemsep=6pt, parsep=0pt, topsep=3pt]
    
    \item \bibentry{he2026s}.
    \item \bibentry{wang2026hyperbolic}.
...
\begin{enumerate}[leftmargin=2em, itemsep=6pt, parsep=0pt, topsep=3pt]
    ...
    \item \bibentry{hong2025good}
    \item \bibentry{tan2025multi}
...
\begin{rSection}{Academic Services}
 ...
 \begin{itemize}[leftmargin=1.5em, itemsep=2pt, parsep=0pt, topsep=3pt]
    \item Reviewer for International Conference on Learning Representations (ICLR) 2025, 2026
    \item Reviewer for AAAI Conference on Artificial Intelligence (AAAI) 2026
